...
def main(arglist):
    desc = """
              Shifts markers in IMOD fiducial file generated by ET-SPEC

              Using IMOD tools this script reads in an IMOD .fid file to
              obtain markers. The script then shifts these markers by values
              set in --xshift and --yshift writing the results to another IMOD
              .fid file.

              It is assumed the input file is a binary IMOD file.
           """
